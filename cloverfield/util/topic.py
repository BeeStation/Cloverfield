...
async def query_server(game_server:str = ACTIVE_SERVER, game_port:int = ACTIVE_PORT, querystr="?status", bother_parsing:bool = True) -> dict:
    """
    ...
    try:
        ...
        conn.settimeout(CALLBACK_TIMEOUT) #Byond is slow, timeout set relatively high to account for any latency
